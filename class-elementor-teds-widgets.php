<?php
/**
 * Elementor_Teds_Widgets class.
 *
 * @category   Class
 * @package    Elementor_Teds_Widgets
...
/**
 * Main Elementor TedsWidgets Class
 *
 * The init class that runs the Elementor TedsWidgets plugin.
 * Intended To make sure that the plugin's minimum
 ...
 */
final class Elementor_Teds_Widgets {
	...
	public function i18n() {
		load_plugin_textdomain( 'elementor-teds-widgets' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( PLUGIN_TEDS ) );
...
// Instantiate Elementor_Teds_Widgets.
new Elementor_Teds_Widgets();
